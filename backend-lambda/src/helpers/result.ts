...
export const isFailure = <Failure, Success>(value: Result<Failure, Success>): value is FailureT<Failure> => value.ok === false;

export const isSuccess = <Failure, Success>(value: Result<Failure, Success>): value is SuccessT<Success> => value.ok === true;
